...
${TESTDIR}/tests/BugTestRunner.o: tests/BugTestRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BugTestRunner.o tests/BugTestRunner.cpp
...
${TESTDIR}/tests/MarkerTest.o: tests/MarkerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MarkerTest.o tests/MarkerTest.cpp


${TESTDIR}/tests/MarkerTestRunner.cpp.o: tests/MarkerTestRunner.cpp.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MarkerTestRunner.cpp.o tests/MarkerTestRunner.cpp.cpp
